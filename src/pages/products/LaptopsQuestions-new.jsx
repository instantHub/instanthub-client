...
//   const { productsData, deductions, handleLabelSelection, rtkData } = props;
//   //   console.log(productsData, deductions, handleLabelSelection);
//   console.log("rtkData", rtkData);
...
//   console.log("deductions from LaptopQuestions", data);
...
//     const operation = selectedOption.getAttribute("data-arg3");
...
//     // }
//     dispatch(addDeductions({ conditionLabel, priceDrop, operation }));

//     // Call your function with the selected option's arguments
//     // handleLabelSelection(arg1, arg2);
//     // handleLabelSelection(conditionLabel, priceDrop, operation);
...
//     if (productsData) {
//       prodVariant = {
//         productCategory: rtkData.productCategory,
//         productName: rtkData.productName,
//         productImage: rtkData.productImage,
//         variantName: rtkData.getUpTo.variantName,
//         price: rtkData.getUpTo.price,
//       };
