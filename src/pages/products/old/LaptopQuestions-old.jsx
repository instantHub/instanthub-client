...
const LaptopsQuestions = (props) => {
  ...
  //   conditionName.includes("Screen Size") || conditionName.includes("Graphics")
  // );
                    ...
                    <div>
                      {!deduction.conditionName.includes("Age") ? (
                        <>
                                ...
                                <div key={index}>
                                  ...
                                  >
                                    <img
                                      ...
                                      className={`
                                      ${
                                        deduction.conditionName.includes(
                                          "Graphic"
                                        )
                                          ? "hidden p-0"
                                          : ""
                          ...
                          <DeductionItems
                            // key={index}
                            conditionName={deduction.conditionName}
                            conditionLabels={deduction.conditionLabels}
