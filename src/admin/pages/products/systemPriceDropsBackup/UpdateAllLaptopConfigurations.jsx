...
const UpdateAllLaptopConfigurations = () => {
            ...
            laptopDesktop.includes(productData.category.name.toLowerCase()) && (
              <>
                <h3 className="text-2xl font-serif text-center font-bold">
                  All {productData.category.name} Configurations to update
                </h3>
                <form onSubmit={handleSubmit}>
                  ...
                  <UpdateButton
                    text={`Update All ${productData.category.name} Configurations`}
...
export default UpdateAllLaptopConfigurations;
