...
const UpdateAllLaptopConditions = (props) => {
  const {
    productData,
        ...
        <form onSubmit={() => handleSubmit(event)}>
          <div>
            ...
            <span className="flex justify-center text-lg font-serif">
              Update All {productData.category.name} Processor Conditions
            </span>
          ...
          <UpdateButton
            text={`Update All ${productData.category.name} Conditions`}
...
export default UpdateAllLaptopConditions;
